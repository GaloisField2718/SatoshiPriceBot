...
async def helper(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message_help += sep2 + remind_numbers + message_btc2eur + message_eur2btc + message_btc2sat + message_sat2btc + message_sat2eur + message_eur2sat + sep_fees + message_fees + message_max_fees + \
